...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($name) || empty($category) || empty($quantity)) {
        ...
        $update_query = "UPDATE resources SET name = ?, description = ?, category = ?, 
                         specifications = ?, status = ?, quantity = ? WHERE id = ?";
        $update_stmt = $conn->prepare($update_query);
        $update_stmt->bind_param("sssssii", $name, $description, $category, $specifications, $status, $quantity, $resource_id);
        ...
        if ($update_stmt->execute()) {
            ...
            $resource['specifications'] = $specifications;
...
<head>
    ...
    <title>Tams-Hub | Edit Resource</title>
...
<main class="content-wrapper">
    <header class="topbar">
        ...
        <div class="topbar-title">Edit Resource</div>
    ...
    <div class="page-content-centered">
        ...
        <div class="form-panel">
            <h2><i class="fa-solid fa-pen"></i> Edit Resource</h2>
            ...
            <form method="POST" action="edit_resource.php?id=<?php echo $resource_id; ?>">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" value="<?php echo htmlspecialchars($resource['name']); ?>" required>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select id="category" name="category" required>
                            <option value="Hardware" <?php echo $resource['category'] == 'Hardware' ? 'selected' : ''; ?>>Hardware</option>
                            <option value="Room" <?php echo $resource['category'] == 'Room' ? 'selected' : ''; ?>>Room</option>
                            <option value="Equipment" <?php echo $resource['category'] == 'Equipment' ? 'selected' : ''; ?>>Equipment</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="quantity" name="quantity" value="<?php echo $resource['quantity']; ?>" min="1" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="specifications" name="specifications" rows="3"><?php echo htmlspecialchars($resource['specifications']); ?></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="status" name="status" required>
                        ...
                        <option value="Reserved" <?php echo $resource['status'] == 'Reserved' ? 'selected' : ''; ?>>Reserved</option>
                        <option value="Out for Repair" <?php echo $resource['status'] == 'Out for Repair' ? 'selected' : ''; ?>>Out for Repair</option>
                        <option value="Unavailable" <?php echo $resource['status'] == 'Unavailable' ? 'selected' : ''; ?>>Unavailable</option>
                    </select>
                </div>

                <div class="form-actions">
                    <button type="submit" class="btn-submit"><i class="fa-solid fa-floppy-disk"></i> Update Resource</button>
